...
df = df.rename({'United States of America': 'USA'})
...
plt.xticks(range(0,7), ['Chile','China','Germany','Mexico','USA','Zimbabwe'], rotation='30')
plt.show()
...
plt.bar(df['Country'], df['LEABY']) #Life expectancy at birth (years)
...
# Same LEABY in different country. GDP not correlated.
...
# 1 China and USA
# 2 China 2005-2015, USA 2004-2007, 2010-2015
# 3 Zimbabwe, Chilie
# 4 USA and China forwards.
# 5 There is no direct relationship between the bars
# 6 Bad economy, Insufficient resources, 
...
plt.savefig("Step8.ScatterPlotsofGDPandLifeExpectancyData.png")
...
plt.savefig("Step9.LinePlotsforLifeExpectancy.png")
...
plt.savefig("Step10.LinePlotsforGDP.png")
...
#Low taxes, сheap labor, Attracting foreign investment (iPhone, Samsung phones and same etc).
#Priority of state interests over ideological
...
#IMHO "Scatter Plots of GDP and Life Expectancy Data" better graph
